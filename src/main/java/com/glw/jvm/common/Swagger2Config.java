package com.glw.jvm.common;

import com.glw.jvm.JvmApplication;
...
public class Swagger2Config {
    ...
    private String basePackage = JvmApplication.class.getPackage().getName();
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("jvm后台服务 OPEN RESTful API文档")
